...
router.put('/:id/approve', authorize(UserRole.RESIDENT, UserRole.GUARD, UserRole.ADMIN), validate(approveVisitorSchema), (req, res, next) => visitorController.approve(req, res, next));
router.put('/:id/reject', authorize(UserRole.RESIDENT, UserRole.GUARD, UserRole.ADMIN), validate(rejectVisitorSchema), (req, res, next) => visitorController.reject(req, res, next));
