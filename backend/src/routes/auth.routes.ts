...
import { registerSchema, loginSchema, refreshTokenSchema, forgotPasswordSchema, resetPasswordSchema, registerDeviceSchema, updatePreferencesSchema, googleLoginSchema } from '../validators/auth.validator';
